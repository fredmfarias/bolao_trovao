function atualizaContador(YY, MM, DD, HH, MI, saida) {
	...
	var futuro = new Date(YY, MM - 1, DD, HH, MI, SS); // Data limite do
														// contador

	var ss = parseInt((futuro - hoje) / 1000); // Determina a quantidade total
												// de segundos que faltam
	var mm = parseInt(ss / 60); // Determina a quantidade total de minutos que
								// faltam
	var hh = parseInt(mm / 60); // Determina a quantidade total de horas que
								// faltam
	var dd = parseInt(hh / 24); // Determina a quantidade total de dias que
								// faltam
...
window.onload=function(){
	atualizaContador('2014','07','14','23','00','elemento');
};