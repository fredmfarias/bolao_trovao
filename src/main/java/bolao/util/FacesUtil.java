...
public class FacesUtil {
    ...
    public static void renderComponent(FacesContext facesContext, String clientId) {
    ...
    public static void renderComponent(FacesContext facesContext, UIComponent uiComponent) {
        renderComponent(facesContext, uiComponent.getClientId(facesContext));
    }
    
    public static void resetEditableValueHolders() {
        Set<VisitHint> VISIT_HINTS = EnumSet.of(VisitHint.SKIP_TRANSIENT);
        FacesContext context = FacesContext.getCurrentInstance();
        ...
        if (partialViewContext.isAjaxRequest()) {
            ...
            if (!renderIds.isEmpty() && !renderIds.containsAll(executeIds)) {
                FacesUtil.resetEditableValueHolders(
                        VisitContext.createVisitContext(context, renderIds, VISIT_HINTS),
     ...
     * @param component The starting point of the component hierarchy to look
     * for editable value holder components.
        ...
        component.visitTree(context, new VisitCallback() {
            ...
            public VisitResult visit(VisitContext context, UIComponent target) {
                ...
                if (target instanceof EditableValueHolder) {
                    ...
                    // Render ID didn't point an EditableValueHolder. Visit all children
                    // as well.
                    FacesUtil.resetEditableValueHolders(VisitContext.createVisitContext(
                            context.getFacesContext(), null, context.getHints()), target,
                            executeIds);
                }
